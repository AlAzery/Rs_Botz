...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 • selldiamond`)
        ...
        const katalog = (teks) => {
             res = zee.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 999999999, "message": teks, "footerText": "©Zeebot", "jpegThumbnail": fs.readFileSync('./media/alazery.jpg'), "surface": 'CATALOG' }}, {quoted:troli})
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            'END:VCARD'.trim()
zee.sendMessage(from, {displayName: `Creator Alazery`, vcard: vcard3}, contact, 
{ quoted: troli, 
})
break
